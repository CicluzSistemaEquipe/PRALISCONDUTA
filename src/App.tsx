...
const AdminTreinamentoEditor = lazyWithRetry(() => import('./admin/pages/AdminTreinamentoEditor'))
        ...
        <ErrorBoundary>
          <Routes location={location}>
            ...
            <Route path="/admin" element={<AdminLayout />}>
              ...
              <Route path="treinamentos/:id" element={<AdminGuard requireDono><AdminTreinamentoEditor /></AdminGuard>} />
